...
#define CONFIGURE_ARGS " '--prefix=/b/.local/pg18/install' '--without-icu' '--without-zlib' '--without-readline' '--without-libxml' '--without-lz4' '--without-zstd' 'CFLAGS=-O2 -g -fPIC -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=0 -DWAIT_USE_SELF_PIPE -idirafter /usr/include' 'CC=musl-gcc'"
...
#define PG_VERSION_STR "PostgreSQL 18.4 on x86_64-pc-linux-musl, compiled by gcc (GCC) 13.3.1 20240913 (Red Hat 13.3.1-3), 64-bit"
