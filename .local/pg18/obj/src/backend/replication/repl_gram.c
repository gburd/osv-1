...
#line 1 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
  ...
  if (yydebug)                                                            \
    {                                                                     \
      ...
      yy_symbol_print (stderr,                                            \
                  Kind, Value, replication_parse_result_p, yyscanner); \
      YYFPRINTF (stderr, "\n");                                           \
    }                                                                     \
} while (0)
...
yy_symbol_value_print (FILE *yyo,
                       yysymbol_kind_t yykind, YYSTYPE const * const yyvaluep, Node **replication_parse_result_p, yyscan_t yyscanner)
{
  FILE *yyoutput = yyo;
  YY_USE (yyoutput);
  YY_USE (replication_parse_result_p);
  YY_USE (yyscanner);
  if (!yyvaluep)
    return;
                 ...
                 yysymbol_kind_t yykind, YYSTYPE const * const yyvaluep, Node **replication_parse_result_p, yyscan_t yyscanner)
{
  ...
  yy_symbol_value_print (yyo, yykind, yyvaluep, replication_parse_result_p, yyscanner);
  YYFPRINTF (yyo, ")");
}
...
yy_reduce_print (yy_state_t *yyssp, YYSTYPE *yyvsp,
                 int yyrule, Node **replication_parse_result_p, yyscan_t yyscanner)
{
  ...
  for (yyi = 0; yyi < yynrhs; yyi++)
    {
      ...
      yy_symbol_print (stderr,
                       ...
                       &yyvsp[(yyi + 1) - (yynrhs)], replication_parse_result_p, yyscanner);
      YYFPRINTF (stderr, "\n");
    }
}
...
do {                                    \
  if (yydebug)                          \
    yy_reduce_print (yyssp, yyvsp, Rule, replication_parse_result_p, yyscanner); \
} while (0)
...
yydestruct (const char *yymsg,
            yysymbol_kind_t yykind, YYSTYPE *yyvaluep, Node **replication_parse_result_p, yyscan_t yyscanner)
{
  YY_USE (yyvaluep);
  YY_USE (replication_parse_result_p);
  YY_USE (yyscanner);
...
#line 103 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                {
					*replication_parse_result_p = (yyvsp[-1].node);
...
#line 133 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                {
...
#line 143 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                {
					ReadReplicationSlotCmd *n = makeNode(ReadReplicationSlotCmd);
					n->slotname = (yyvsp[0].str);
					(yyval.node) = (Node *) n;
				}
#line 1272 "repl_gram.c"
    break;

  case 18: /* show: K_SHOW var_name  */
#line 155 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                {
...
#line 161 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                        { (yyval.str) = (yyvsp[0].str); }
#line 1288 "repl_gram.c"
    break;

  case 20: /* var_name: var_name '.' IDENT  */
#line 163 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                { (yyval.str) = psprintf("%s.%s", (yyvsp[-2].str), (yyvsp[0].str)); }
#line 1294 "repl_gram.c"
    break;

  case 21: /* base_backup: K_BASE_BACKUP '(' generic_option_list ')'  */
#line 171 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                {
					BaseBackupCmd *cmd = makeNode(BaseBackupCmd);
					cmd->options = (yyvsp[-1].list);
					(yyval.node) = (Node *) cmd;
				}
#line 1304 "repl_gram.c"
    break;

  case 22: /* base_backup: K_BASE_BACKUP  */
#line 177 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                {
					BaseBackupCmd *cmd = makeNode(BaseBackupCmd);
					(yyval.node) = (Node *) cmd;
				}
...
#line 186 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                {
...
#line 197 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                {
					CreateReplicationSlotCmd *cmd;
					cmd = makeNode(CreateReplicationSlotCmd);
...
#line 210 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                                                        { (yyval.list) = (yyvsp[-1].list); }
#line 1348 "repl_gram.c"
    break;

  case 26: /* create_slot_options: create_slot_legacy_opt_list  */
#line 211 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                                                { (yyval.list) = (yyvsp[0].list); }
#line 1354 "repl_gram.c"
    break;

  case 27: /* create_slot_legacy_opt_list: create_slot_legacy_opt_list create_slot_legacy_opt  */
#line 216 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                { (yyval.list) = lappend((yyvsp[-1].list), (yyvsp[0].defelt)); }
#line 1360 "repl_gram.c"
    break;

  case 28: /* create_slot_legacy_opt_list: %empty  */
#line 218 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                { (yyval.list) = NIL; }
#line 1366 "repl_gram.c"
    break;

  case 29: /* create_slot_legacy_opt: K_EXPORT_SNAPSHOT  */
#line 223 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                {
				  (yyval.defelt) = makeDefElem("snapshot",
								   (Node *) makeString("export"), -1);
				}
#line 1375 "repl_gram.c"
    break;

  case 30: /* create_slot_legacy_opt: K_NOEXPORT_SNAPSHOT  */
#line 228 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                {
				  (yyval.defelt) = makeDefElem("snapshot",
								   (Node *) makeString("nothing"), -1);
				}
#line 1384 "repl_gram.c"
    break;

  case 31: /* create_slot_legacy_opt: K_USE_SNAPSHOT  */
#line 233 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                {
				  (yyval.defelt) = makeDefElem("snapshot",
...
#line 238 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                {
...
#line 243 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                {
...
#line 252 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                {
...
#line 260 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                {
					DropReplicationSlotCmd *cmd;
					cmd = makeNode(DropReplicationSlotCmd);
...
#line 272 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                {
...
#line 286 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                {
...
#line 301 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                {
					StartReplicationCmd *cmd;
					cmd = makeNode(StartReplicationCmd);
					cmd->kind = REPLICATION_KIND_LOGICAL;
...
#line 316 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                {
...
#line 334 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                {
...
#line 346 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                                                                { (yyval.boolval) = true; }
#line 1510 "repl_gram.c"
    break;

  case 44: /* opt_temporary: %empty  */
#line 347 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                                                        { (yyval.boolval) = false; }
#line 1516 "repl_gram.c"
    break;

  case 45: /* opt_slot: K_SLOT IDENT  */
#line 352 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                { (yyval.str) = (yyvsp[0].str); }
#line 1522 "repl_gram.c"
    break;

  case 46: /* opt_slot: %empty  */
#line 354 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                { (yyval.str) = NULL; }
#line 1528 "repl_gram.c"
    break;

  case 47: /* opt_timeline: K_TIMELINE UCONST  */
#line 359 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                {
					if ((yyvsp[0].uintval) <= 0)
						ereport(ERROR,
								(errcode(ERRCODE_SYNTAX_ERROR),
...
#line 366 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                                                { (yyval.uintval) = 0; }
#line 1546 "repl_gram.c"
    break;

  case 49: /* plugin_options: '(' plugin_opt_list ')'  */
#line 371 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                                                { (yyval.list) = (yyvsp[-1].list); }
#line 1552 "repl_gram.c"
    break;

  case 50: /* plugin_options: %empty  */
#line 372 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                                                        { (yyval.list) = NIL; }
#line 1558 "repl_gram.c"
    break;

  case 51: /* plugin_opt_list: plugin_opt_elem  */
#line 377 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                {
...
#line 381 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                {
...
#line 388 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                {
...
#line 394 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                                                                { (yyval.node) = (Node *) makeString((yyvsp[0].str)); }
#line 1588 "repl_gram.c"
    break;

  case 55: /* plugin_opt_arg: %empty  */
#line 395 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                                                        { (yyval.node) = NULL; }
#line 1594 "repl_gram.c"
    break;

  case 56: /* generic_option_list: generic_option_list ',' generic_option  */
#line 400 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                { (yyval.list) = lappend((yyvsp[-2].list), (yyvsp[0].defelt)); }
#line 1600 "repl_gram.c"
    break;

  case 57: /* generic_option_list: generic_option  */
#line 402 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                { (yyval.list) = list_make1((yyvsp[0].defelt)); }
#line 1606 "repl_gram.c"
    break;

  case 58: /* generic_option: ident_or_keyword  */
#line 407 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                {
...
#line 411 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                {
...
#line 415 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                {
					(yyval.defelt) = makeDefElem((yyvsp[-1].str), (Node *) makeString((yyvsp[0].str)), -1);
				}
...
#line 419 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                {
					(yyval.defelt) = makeDefElem((yyvsp[-1].str), (Node *) makeInteger((yyvsp[0].uintval)), -1);
				}
#line 1638 "repl_gram.c"
    break;

  case 62: /* ident_or_keyword: IDENT  */
#line 425 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                                                                { (yyval.str) = (yyvsp[0].str); }
#line 1644 "repl_gram.c"
    break;

  case 63: /* ident_or_keyword: K_BASE_BACKUP  */
#line 426 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                                                        { (yyval.str) = "base_backup"; }
#line 1650 "repl_gram.c"
    break;

  case 64: /* ident_or_keyword: K_IDENTIFY_SYSTEM  */
#line 427 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                                                        { (yyval.str) = "identify_system"; }
#line 1656 "repl_gram.c"
    break;

  case 65: /* ident_or_keyword: K_SHOW  */
#line 428 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                                                                { (yyval.str) = "show"; }
#line 1662 "repl_gram.c"
    break;

  case 66: /* ident_or_keyword: K_START_REPLICATION  */
#line 429 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                                                { (yyval.str) = "start_replication"; }
#line 1668 "repl_gram.c"
    break;

  case 67: /* ident_or_keyword: K_CREATE_REPLICATION_SLOT  */
#line 430 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                                        { (yyval.str) = "create_replication_slot"; }
#line 1674 "repl_gram.c"
    break;

  case 68: /* ident_or_keyword: K_DROP_REPLICATION_SLOT  */
#line 431 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                                                { (yyval.str) = "drop_replication_slot"; }
#line 1680 "repl_gram.c"
    break;

  case 69: /* ident_or_keyword: K_ALTER_REPLICATION_SLOT  */
#line 432 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                                                { (yyval.str) = "alter_replication_slot"; }
#line 1686 "repl_gram.c"
    break;

  case 70: /* ident_or_keyword: K_TIMELINE_HISTORY  */
#line 433 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                                                { (yyval.str) = "timeline_history"; }
#line 1692 "repl_gram.c"
    break;

  case 71: /* ident_or_keyword: K_WAIT  */
#line 434 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                                                                { (yyval.str) = "wait"; }
#line 1698 "repl_gram.c"
    break;

  case 72: /* ident_or_keyword: K_TIMELINE  */
#line 435 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                                                        { (yyval.str) = "timeline"; }
#line 1704 "repl_gram.c"
    break;

  case 73: /* ident_or_keyword: K_PHYSICAL  */
#line 436 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                                                        { (yyval.str) = "physical"; }
#line 1710 "repl_gram.c"
    break;

  case 74: /* ident_or_keyword: K_LOGICAL  */
#line 437 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                                                                { (yyval.str) = "logical"; }
#line 1716 "repl_gram.c"
    break;

  case 75: /* ident_or_keyword: K_SLOT  */
#line 438 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                                                                { (yyval.str) = "slot"; }
#line 1722 "repl_gram.c"
    break;

  case 76: /* ident_or_keyword: K_RESERVE_WAL  */
#line 439 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                                                        { (yyval.str) = "reserve_wal"; }
#line 1728 "repl_gram.c"
    break;

  case 77: /* ident_or_keyword: K_TEMPORARY  */
#line 440 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                                                        { (yyval.str) = "temporary"; }
#line 1734 "repl_gram.c"
    break;

  case 78: /* ident_or_keyword: K_TWO_PHASE  */
#line 441 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                                                        { (yyval.str) = "two_phase"; }
#line 1740 "repl_gram.c"
    break;

  case 79: /* ident_or_keyword: K_EXPORT_SNAPSHOT  */
#line 442 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                                                        { (yyval.str) = "export_snapshot"; }
#line 1746 "repl_gram.c"
    break;

  case 80: /* ident_or_keyword: K_NOEXPORT_SNAPSHOT  */
#line 443 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                                                { (yyval.str) = "noexport_snapshot"; }
#line 1752 "repl_gram.c"
    break;

  case 81: /* ident_or_keyword: K_USE_SNAPSHOT  */
#line 444 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                                                        { (yyval.str) = "use_snapshot"; }
#line 1758 "repl_gram.c"
    break;

  case 82: /* ident_or_keyword: K_UPLOAD_MANIFEST  */
#line 445 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
                                                                        { (yyval.str) = "upload_manifest"; }
#line 1764 "repl_gram.c"
    break;


#line 1768 "repl_gram.c"
  ...
  for (;;)
    {
      ...
      yydestruct ("Error: popping",
                  YY_ACCESSING_SYMBOL (yystate), yyvsp, replication_parse_result_p, yyscanner);
      YYPOPSTACK (1);
      yystate = *yyssp;
      YY_STACK_PRINT (yyss, yyssp);
    }
  ...
  while (yyssp != yyss)
    {
      yydestruct ("Cleanup: popping",
                  YY_ACCESSING_SYMBOL (+*yyssp), yyvsp, replication_parse_result_p, yyscanner);
      YYPOPSTACK (1);
    }
#ifndef yyoverflow
  if (yyss != yyssa)
...
#line 448 "/b/.local/pg18/src/src/backend/replication/repl_gram.y"
