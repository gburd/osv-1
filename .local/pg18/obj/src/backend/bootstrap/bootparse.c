...
#line 1 "/b/.local/pg18/src/src/backend/bootstrap/bootparse.y"
...
#line 139 "/b/.local/pg18/src/src/backend/bootstrap/bootparse.y"
                                {
					do_start();
...
#line 150 "/b/.local/pg18/src/src/backend/bootstrap/bootparse.y"
                                {
					do_start();
					closerel((yyvsp[0].str));
					do_end();
				}
#line 1303 "bootparse.c"
    break;

  case 16: /* $@1: %empty  */
#line 159 "/b/.local/pg18/src/src/backend/bootstrap/bootparse.y"
                                {
					do_start();
					numattr = 0;
...
#line 1317 "bootparse.c"
    break;

  case 17: /* $@2: %empty  */
#line 169 "/b/.local/pg18/src/src/backend/bootstrap/bootparse.y"
                                {
					do_end();
				}
#line 1325 "bootparse.c"
    break;
...
#line 173 "/b/.local/pg18/src/src/backend/bootstrap/bootparse.y"
                                {
					TupleDesc	tupdesc;
...
#line 1409 "bootparse.c"
  ...
  case 19: /* $@3: %empty  */
#line 256 "/b/.local/pg18/src/src/backend/bootstrap/bootparse.y"
                                {
					do_start();
...
#line 262 "/b/.local/pg18/src/src/backend/bootstrap/bootparse.y"
                                {
...
#line 275 "/b/.local/pg18/src/src/backend/bootstrap/bootparse.y"
                                {
...
#line 328 "/b/.local/pg18/src/src/backend/bootstrap/bootparse.y"
                                {
					IndexStmt  *stmt = makeNode(IndexStmt);
					Oid			relationId;
...
#line 1541 "bootparse.c"
    break;

  case 23: /* Boot_DeclareToastStmt: XDECLARE XTOAST oidspec oidspec ON boot_ident  */
#line 381 "/b/.local/pg18/src/src/backend/bootstrap/bootparse.y"
                                {
...
#line 393 "/b/.local/pg18/src/src/backend/bootstrap/bootparse.y"
                                {
					do_start();
					build_indices();
					do_end();
				}
#line 1564 "bootparse.c"
    break;

  case 25: /* boot_index_params: boot_index_params COMMA boot_index_param  */
#line 402 "/b/.local/pg18/src/src/backend/bootstrap/bootparse.y"
                                                                { (yyval.list) = lappend((yyvsp[-2].list), (yyvsp[0].ielem)); }
#line 1570 "bootparse.c"
    break;

  case 26: /* boot_index_params: boot_index_param  */
#line 403 "/b/.local/pg18/src/src/backend/bootstrap/bootparse.y"
                                                                                        { (yyval.list) = list_make1((yyvsp[0].ielem)); }
#line 1576 "bootparse.c"
    break;

  case 27: /* boot_index_param: boot_ident boot_ident  */
#line 408 "/b/.local/pg18/src/src/backend/bootstrap/bootparse.y"
                                {
...
#line 1593 "bootparse.c"
    break;

  case 28: /* optbootstrap: XBOOTSTRAP  */
#line 423 "/b/.local/pg18/src/src/backend/bootstrap/bootparse.y"
                                        { (yyval.ival) = 1; }
#line 1599 "bootparse.c"
    break;

  case 29: /* optbootstrap: %empty  */
#line 424 "/b/.local/pg18/src/src/backend/bootstrap/bootparse.y"
                                                { (yyval.ival) = 0; }
#line 1605 "bootparse.c"
    break;

  case 30: /* optsharedrelation: XSHARED_RELATION  */
#line 428 "/b/.local/pg18/src/src/backend/bootstrap/bootparse.y"
                                                { (yyval.ival) = 1; }
#line 1611 "bootparse.c"
    break;

  case 31: /* optsharedrelation: %empty  */
#line 429 "/b/.local/pg18/src/src/backend/bootstrap/bootparse.y"
                                                                { (yyval.ival) = 0; }
#line 1617 "bootparse.c"
    break;

  case 32: /* optrowtypeoid: XROWTYPE_OID oidspec  */
#line 433 "/b/.local/pg18/src/src/backend/bootstrap/bootparse.y"
                                                { (yyval.oidval) = (yyvsp[0].oidval); }
#line 1623 "bootparse.c"
    break;

  case 33: /* optrowtypeoid: %empty  */
#line 434 "/b/.local/pg18/src/src/backend/bootstrap/bootparse.y"
                                                                        { (yyval.oidval) = InvalidOid; }
#line 1629 "bootparse.c"
    break;

  case 36: /* boot_column_def: boot_ident EQUALS boot_ident boot_column_nullness  */
#line 444 "/b/.local/pg18/src/src/backend/bootstrap/bootparse.y"
                                {
				   if (++numattr > MAXATTR)
						elog(FATAL, "too many columns");
				   DefineAttr((yyvsp[-3].str), (yyvsp[-1].str), numattr-1, (yyvsp[0].ival));
				}
#line 1639 "bootparse.c"
    break;

  case 37: /* boot_column_nullness: XFORCE XNOT XNULL  */
#line 452 "/b/.local/pg18/src/src/backend/bootstrap/bootparse.y"
                                                { (yyval.ival) = BOOTCOL_NULL_FORCE_NOT_NULL; }
#line 1645 "bootparse.c"
    break;

  case 38: /* boot_column_nullness: XFORCE XNULL  */
#line 453 "/b/.local/pg18/src/src/backend/bootstrap/bootparse.y"
                                                {  (yyval.ival) = BOOTCOL_NULL_FORCE_NULL; }
#line 1651 "bootparse.c"
    break;

  case 39: /* boot_column_nullness: %empty  */
#line 454 "/b/.local/pg18/src/src/backend/bootstrap/bootparse.y"
                  { (yyval.ival) = BOOTCOL_NULL_AUTO; }
#line 1657 "bootparse.c"
    break;

  case 40: /* oidspec: boot_ident  */
#line 458 "/b/.local/pg18/src/src/backend/bootstrap/bootparse.y"
                                                                                        { (yyval.oidval) = atooid((yyvsp[0].str)); }
#line 1663 "bootparse.c"
    break;

  case 44: /* boot_column_val: boot_ident  */
#line 469 "/b/.local/pg18/src/src/backend/bootstrap/bootparse.y"
                        { InsertOneValue((yyvsp[0].str), num_columns_read++); }
#line 1669 "bootparse.c"
    break;

  case 45: /* boot_column_val: NULLVAL  */
#line 471 "/b/.local/pg18/src/src/backend/bootstrap/bootparse.y"
                        { InsertOneNull(num_columns_read++); }
#line 1675 "bootparse.c"
    break;

  case 46: /* boot_ident: ID  */
#line 475 "/b/.local/pg18/src/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = (yyvsp[0].str); }
#line 1681 "bootparse.c"
    break;

  case 47: /* boot_ident: OPEN  */
#line 476 "/b/.local/pg18/src/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1687 "bootparse.c"
    break;

  case 48: /* boot_ident: XCLOSE  */
#line 477 "/b/.local/pg18/src/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1693 "bootparse.c"
    break;

  case 49: /* boot_ident: XCREATE  */
#line 478 "/b/.local/pg18/src/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1699 "bootparse.c"
    break;

  case 50: /* boot_ident: INSERT_TUPLE  */
#line 479 "/b/.local/pg18/src/src/backend/bootstrap/bootparse.y"
                                { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1705 "bootparse.c"
    break;

  case 51: /* boot_ident: XDECLARE  */
#line 480 "/b/.local/pg18/src/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1711 "bootparse.c"
    break;

  case 52: /* boot_ident: INDEX  */
#line 481 "/b/.local/pg18/src/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1717 "bootparse.c"
    break;

  case 53: /* boot_ident: ON  */
#line 482 "/b/.local/pg18/src/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1723 "bootparse.c"
    break;

  case 54: /* boot_ident: USING  */
#line 483 "/b/.local/pg18/src/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1729 "bootparse.c"
    break;

  case 55: /* boot_ident: XBUILD  */
#line 484 "/b/.local/pg18/src/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1735 "bootparse.c"
    break;

  case 56: /* boot_ident: INDICES  */
#line 485 "/b/.local/pg18/src/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1741 "bootparse.c"
    break;

  case 57: /* boot_ident: UNIQUE  */
#line 486 "/b/.local/pg18/src/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1747 "bootparse.c"
    break;

  case 58: /* boot_ident: XTOAST  */
#line 487 "/b/.local/pg18/src/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1753 "bootparse.c"
    break;

  case 59: /* boot_ident: OBJ_ID  */
#line 488 "/b/.local/pg18/src/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1759 "bootparse.c"
    break;

  case 60: /* boot_ident: XBOOTSTRAP  */
#line 489 "/b/.local/pg18/src/src/backend/bootstrap/bootparse.y"
                                { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1765 "bootparse.c"
    break;

  case 61: /* boot_ident: XSHARED_RELATION  */
#line 490 "/b/.local/pg18/src/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1771 "bootparse.c"
    break;

  case 62: /* boot_ident: XROWTYPE_OID  */
#line 491 "/b/.local/pg18/src/src/backend/bootstrap/bootparse.y"
                                { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1777 "bootparse.c"
    break;

  case 63: /* boot_ident: XFORCE  */
#line 492 "/b/.local/pg18/src/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1783 "bootparse.c"
    break;

  case 64: /* boot_ident: XNOT  */
#line 493 "/b/.local/pg18/src/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1789 "bootparse.c"
    break;

  case 65: /* boot_ident: XNULL  */
#line 494 "/b/.local/pg18/src/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
...
#line 496 "/b/.local/pg18/src/src/backend/bootstrap/bootparse.y"
