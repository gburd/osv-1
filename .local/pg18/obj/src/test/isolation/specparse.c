...
#line 1 "/b/.local/pg18/src/src/test/isolation/specparse.y"
...
#line 67 "/b/.local/pg18/src/src/test/isolation/specparse.y"
                        {
...
#line 1151 "specparse.c"
    break;

  case 3: /* setup_list: %empty  */
#line 80 "/b/.local/pg18/src/src/test/isolation/specparse.y"
                        {
				(yyval.ptr_list).elements = NULL;
				(yyval.ptr_list).nelements = 0;
			}
#line 1160 "specparse.c"
    break;

  case 4: /* setup_list: setup_list setup  */
#line 85 "/b/.local/pg18/src/src/test/isolation/specparse.y"
                        {
...
#line 1171 "specparse.c"
    break;

  case 5: /* opt_setup: %empty  */
#line 94 "/b/.local/pg18/src/src/test/isolation/specparse.y"
                                                        { (yyval.str) = NULL; }
#line 1177 "specparse.c"
    break;

  case 6: /* opt_setup: setup  */
#line 95 "/b/.local/pg18/src/src/test/isolation/specparse.y"
                                                        { (yyval.str) = (yyvsp[0].str); }
#line 1183 "specparse.c"
    break;

  case 7: /* setup: SETUP sqlblock  */
#line 99 "/b/.local/pg18/src/src/test/isolation/specparse.y"
                                                { (yyval.str) = (yyvsp[0].str); }
#line 1189 "specparse.c"
    break;

  case 8: /* opt_teardown: %empty  */
#line 103 "/b/.local/pg18/src/src/test/isolation/specparse.y"
                                                        { (yyval.str) = NULL; }
#line 1195 "specparse.c"
    break;

  case 9: /* opt_teardown: TEARDOWN sqlblock  */
#line 104 "/b/.local/pg18/src/src/test/isolation/specparse.y"
                                                { (yyval.str) = (yyvsp[0].str); }
#line 1201 "specparse.c"
    break;

  case 10: /* session_list: session_list session  */
#line 109 "/b/.local/pg18/src/src/test/isolation/specparse.y"
                        {
				(yyval.ptr_list).elements = pg_realloc((yyvsp[-1].ptr_list).elements,
										 ((yyvsp[-1].ptr_list).nelements + 1) * sizeof(void *));
...
#line 1212 "specparse.c"
    break;

  case 11: /* session_list: session  */
#line 116 "/b/.local/pg18/src/src/test/isolation/specparse.y"
                        {
...
#line 125 "/b/.local/pg18/src/src/test/isolation/specparse.y"
                        {
...
#line 1235 "specparse.c"
    break;

  case 13: /* step_list: step_list step  */
#line 137 "/b/.local/pg18/src/src/test/isolation/specparse.y"
                        {
				(yyval.ptr_list).elements = pg_realloc((yyvsp[-1].ptr_list).elements,
										 ((yyvsp[-1].ptr_list).nelements + 1) * sizeof(void *));
...
#line 1246 "specparse.c"
    break;

  case 14: /* step_list: step  */
#line 144 "/b/.local/pg18/src/src/test/isolation/specparse.y"
                        {
				(yyval.ptr_list).nelements = 1;
				(yyval.ptr_list).elements = pg_malloc(sizeof(void *));
				(yyval.ptr_list).elements[0] = (yyvsp[0].step);
			}
#line 1256 "specparse.c"
    break;

  case 15: /* step: STEP identifier sqlblock  */
#line 154 "/b/.local/pg18/src/src/test/isolation/specparse.y"
                        {
...
#line 166 "/b/.local/pg18/src/src/test/isolation/specparse.y"
                        {
				(yyval.ptr_list) = (yyvsp[0].ptr_list);
			}
#line 1276 "specparse.c"
    break;

  case 17: /* opt_permutation_list: %empty  */
#line 170 "/b/.local/pg18/src/src/test/isolation/specparse.y"
                        {
				(yyval.ptr_list).elements = NULL;
				(yyval.ptr_list).nelements = 0;
			}
#line 1285 "specparse.c"
    break;

  case 18: /* permutation_list: permutation_list permutation  */
#line 177 "/b/.local/pg18/src/src/test/isolation/specparse.y"
                        {
				(yyval.ptr_list).elements = pg_realloc((yyvsp[-1].ptr_list).elements,
										 ((yyvsp[-1].ptr_list).nelements + 1) * sizeof(void *));
...
#line 1296 "specparse.c"
    break;

  case 19: /* permutation_list: permutation  */
#line 184 "/b/.local/pg18/src/src/test/isolation/specparse.y"
                        {
				(yyval.ptr_list).nelements = 1;
				(yyval.ptr_list).elements = pg_malloc(sizeof(void *));
				(yyval.ptr_list).elements[0] = (yyvsp[0].permutation);
			}
#line 1306 "specparse.c"
    break;

  case 20: /* permutation: PERMUTATION permutation_step_list  */
#line 194 "/b/.local/pg18/src/src/test/isolation/specparse.y"
                        {
...
#line 1316 "specparse.c"
    break;

  case 21: /* permutation_step_list: permutation_step_list permutation_step  */
#line 203 "/b/.local/pg18/src/src/test/isolation/specparse.y"
                        {
				(yyval.ptr_list).elements = pg_realloc((yyvsp[-1].ptr_list).elements,
										 ((yyvsp[-1].ptr_list).nelements + 1) * sizeof(void *));
...
#line 1327 "specparse.c"
    break;

  case 22: /* permutation_step_list: permutation_step  */
#line 210 "/b/.local/pg18/src/src/test/isolation/specparse.y"
                        {
				(yyval.ptr_list).nelements = 1;
				(yyval.ptr_list).elements = pg_malloc(sizeof(void *));
				(yyval.ptr_list).elements[0] = (yyvsp[0].permutationstep);
			}
#line 1337 "specparse.c"
    break;

  case 23: /* permutation_step: identifier  */
#line 219 "/b/.local/pg18/src/src/test/isolation/specparse.y"
                        {
...
#line 1349 "specparse.c"
    break;

  case 24: /* permutation_step: identifier '(' blocker_list ')'  */
#line 227 "/b/.local/pg18/src/src/test/isolation/specparse.y"
                        {
				(yyval.permutationstep) = pg_malloc(sizeof(PermutationStep));
...
#line 1361 "specparse.c"
    break;

  case 25: /* blocker_list: blocker_list ',' blocker  */
#line 238 "/b/.local/pg18/src/src/test/isolation/specparse.y"
                        {
...
#line 245 "/b/.local/pg18/src/src/test/isolation/specparse.y"
                        {
				(yyval.ptr_list).nelements = 1;
				(yyval.ptr_list).elements = pg_malloc(sizeof(void *));
				(yyval.ptr_list).elements[0] = (yyvsp[0].blocker);
			}
#line 1382 "specparse.c"
    break;

  case 27: /* blocker: identifier  */
#line 254 "/b/.local/pg18/src/src/test/isolation/specparse.y"
                        {
...
#line 263 "/b/.local/pg18/src/src/test/isolation/specparse.y"
                        {
				(yyval.blocker) = pg_malloc(sizeof(PermutationStepBlocker));
...
#line 1408 "specparse.c"
    break;

  case 29: /* blocker: '*'  */
#line 272 "/b/.local/pg18/src/src/test/isolation/specparse.y"
                        {
				(yyval.blocker) = pg_malloc(sizeof(PermutationStepBlocker));
...
#line 282 "/b/.local/pg18/src/src/test/isolation/specparse.y"
